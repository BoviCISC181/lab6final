...
public class MainApp extends Application {
	...
	private GameRuleDomainModel grdm;
	private ArrayList<GameRuleCardsDomainModel> grcdmList = new ArrayList<GameRuleCardsDomainModel>();
	
	public GameRuleDomainModel getGRDM(){
		return(grdm);
	}
	public void setGRDM(GameRuleDomainModel grdm){
		this.grdm = grdm;
	}
	...
	public void setGRCDM(ArrayList<GameRuleCardsDomainModel> grcdmS){
		this.grcdmList = grcdmS;
	}
