...
public class Rule {
	...
	public Rule(GameRuleDomainModel rule, int[] cardsDraw){
		this.MaxNumberOfPlayers = rule.getMAXNUMBEROFPLAYERS();
		this.PlayerNumberOfCards = rule.getPLAYERNUMBEROFCARDS();
		this.NumberOfJokers = rule.getNUMBEROFJOKERS();
		this.PlayerCardsMin = rule.getPLAYERCARDSMIN();
		this.PlayerCardsMax = rule.getPLAYERCARDSMAX();
		this.CommunityCardsMin = rule.getCOMMUNITYCARDSMIN();
